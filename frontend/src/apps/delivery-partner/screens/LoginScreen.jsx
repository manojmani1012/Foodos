...
export default function LoginScreen({ onLogin }) {
  ...
  return (
    <div className="dp-screen" style={{ background: '#fff', alignItems: 'center' }}>
      ...
      <div style={{ flex: 1, width: '100%', padding: '40px 28px', display: 'flex', flexDirection: 'column' }}>
        ...
        <p style={{ fontSize: 14, color: '#888', marginBottom: 28 }}>Login to manage your deliveries</p>
        ...
        <button className="dp-btn-outline" style={{ marginTop: 12, border: '1.5px solid #ddd', color: '#333' }} onClick={onLogin}>
